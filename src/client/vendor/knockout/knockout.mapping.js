...
(function (factory) {
	...
	// sfoster: actually, we want to export ko and install ko.mapping
	// but, to avoid changing to much code, see the return value;
	var exports = ko.mapping = {};
	var DEBUG=true;
	...
	// sfoster: export ko not ko.mapping
	return ko;
}));
